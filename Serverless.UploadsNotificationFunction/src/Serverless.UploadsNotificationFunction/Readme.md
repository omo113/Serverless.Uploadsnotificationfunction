...
Execute unit tests
```
    cd "Serverless-UploadsNotificationFunction/test/Serverless-UploadsNotificationFunction.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Serverless-UploadsNotificationFunction/src/Serverless-UploadsNotificationFunction"
